	...
	implements Runnable
{
	...
	/**
	 * Creates a new PageAnalyzer, which has a final implementation of the run()
	 * method.
	 * 
	 * @param pi
	 *            The PageInfo to be analyzed
	 * @param outboundQueue
	 *            The outboundQueue of finished PageInfo
	 */
	 ...
	 * 
	 * @param pi
	 *            The page info of the page to be analyzed
	 */
