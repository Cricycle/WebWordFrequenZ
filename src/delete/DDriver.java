...
/**
 * Manages creation of all PageDeleter threads. Once a PageInfo object has been
 * sent to the queue exactly twice, the downloaded web page that it references
 * will be deleted.
 * 
 * @author Alex
 * 
	...
	implements Runnable
{
	...
	/**
	 * Number of times the PageDeleter threads should try to delete the file if
	 ...
	 * 
	 * @param inboundQueue
	 *            The queue which indicates PageInfo objects have been
	 *            processed.
	 * @param retryCnt
	 *            The number of times the PageDeleter threads should retry if
	 *            they fail to delete the file.
	 */
